...
from isaaclab.assets import RigidObjectCfg, ArticulationCfg, RigidObjectCollectionCfg
...
from isaaclab_tasks.manager_based.manipulation.shelf.src.ur5e import UR5e_CFG
...
class UR5eSweepEnvCfg(ShelfSweepRandomEnvCfg):
    def __post_init__(self):
        ...
        # YAML 파일 로드
        object_cfgs = load_yaml_config(yaml_path="/home/ssu/RL_based_Manipulation/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/shelf/src/environment.yaml")
